...
public class UserRegistrationStepdefs {
    ...
    private String generateFakeEmail() {
        ...
        return "esnad" + timestamp + "@example.com";
    }
    ...
    public void iFillAllInputsWithValidData() {
        ...
        driver.findElement(By.id("member_firstname")).sendKeys("Esnad");
        driver.findElement(By.id("member_lastname")).sendKeys("Eco");
        ...
        driver.findElement(By.id("signupunlicenced_password")).sendKeys("Test12345!");
        driver.findElement(By.id("signupunlicenced_confirmpassword")).sendKeys("Test12345!");
    }
    ...
    // Klickar på "Join" för att skicka formuläret
    @And("I submit the form")
    public void iSubmitTheForm() {
        driver.findElement(By.cssSelector("input[name='join']")).click();
        delay(1);
    }
    // Bekräftar lyckad registrering
    ...
    // Fyller i giltig data utan att efternamn
    @When("I fill in valid data without last name")
    public void iFillInValidDataWithoutLastName() {
        driver.findElement(By.id("dp")).sendKeys("01/01/2000");
        driver.findElement(By.id("member_firstname")).sendKeys("Esnad");
        //WE WRITE WITHOUT LAST NAME
        driver.findElement(By.id("member_emailaddress")).sendKeys("esnad.test@example.com");
        driver.findElement(By.id("member_confirmemailaddress")).sendKeys("esnad.test@example.com");
        driver.findElement(By.id("signupunlicenced_password")).sendKeys("Test12345!");
        driver.findElement(By.id("signupunlicenced_confirmpassword")).sendKeys("Test12345!");
    }
